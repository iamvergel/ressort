...
// Fetch event data from the vrhouse table
$stmt = $pdo->query("SELECT date, session, slots FROM availableslots WHERE name IN ('VR House', '22 Hours')");
...
<body>
    ...
    <div class="container-fluid py-5 mb-5 bg-light">
        ...
        <div class="row">
            <div class="col-lg-7 col-12 px-3">
                ...
                <div class="calendarbg p-2 bg-light shadow-lg rounded-4">
                ...
                <form action="/vrhousebooking" method="post" id="bookingForm" class="bg-light shadow p-5 rounded-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" required
                            pattern="^[a-zA-Z0-9._%+-]+@gmail\.com$" value="<?php echo $_SESSION['email'] ?>" title="Please enter a valid Gmail address." readonly>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $_SESSION['phone'] ?>" name="contact_number" readonly required pattern="^09\d{9}$"
    ...
    <script>
        function changeDate(action) {
            ...
            window.location.href = '/vrhouse?month=' + month + '&year=' + year;
        }
        ...
        function updateSessionSelect() {
            ...
            if (!slotsAvailable) {
                ...
                roomInput.value = "VR House"; // Reset room input
            } else {
                ...
                if (availableSessions.length > 0) {
                    ...
                    if (selectedSession === "AM" || selectedSession === "PM") {
                        ...
                        roomInput.value = "VR House"; // Set room to VR House
                    } else if (selectedSession === "22 Hours") {
                        quantityInput.max = 20; // Set max for 22 Hours
                        roomInput.value = "VR House & VR House"; // Change room to Amacan & VR House
                    }
                }
            }
