...
$stmt = $pdo->prepare("SELECT * FROM inquiries WHERE room = 'Amacan' AND status = 'pending'"); //AND room = 'pending'
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'accept') {
        ...
        try {
            ...
            -Please make the down payment via GCash to 09635977582 and send a screenshot <br/>  of the transaction to our Messenger for confirmation by [Date]
            ...
            - Contact: If you have any questions, contact us at 09635977582 or villareyesfamilyprivateresort@gmail.com.<br/><br/>
