...
$stmt = $pdo->prepare("SELECT * FROM inquiries WHERE room = 'VR House' AND status = 'pending'"); //AND room = 'pending'
$stmt->execute();
$vrInquiries = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Redirect back
    header('Location: /adminInquiries/Vrhouse');
    exit();
}
?>
        ...
        <div class="container-fluid" style="height: 100vh; overflow-y: scroll; scrollbar-width: none;">
            ...
            <div class="container">
                <div class="content">
                    ...
                    <h1 class="fw-bold"><i class="bi bi-house-door-fill me-2"></i>VR House</h1>
                    <div class="table-responsive mt-5">
                        ...
                        <table id="inquiriesTable" class="container table table-hover p-3">
                            ...
                            <tbody class="text-dark" style="font-size: 12px">
                                <?php foreach ($vrInquiries as $inquiry): ?>
                                    <tr>
