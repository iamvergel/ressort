...
<body>
    ...
    <div class="aboutus">
        <div class="whoweare pt-5 px-5 shadow-lg" style="background-color : #011F37ff;" data-aos="fade-up" data-aos-duration="800">
            <div class="container">
                <div class="row pt-5 px-5 mt-5">
                    <div class="col-6 text-light" data-aos="fade-right" data-aos-duration="1000">
                        <p class="mt-5 px-5 pt-5 fw-semibold" style="font-size: 15px; line-height: 1.7; letter-spacing: 1px">Who we are</p>
                        <p class="mt-2 px-5 fw-light" style="font-size: 12px; line-height: 1.7; letter-spacing: 1px">
                            ...
                            In our early days, we successfully hosted numerous family gatherings and created countless cherished memories...
                        </p>
                    </div>
                ...
                <div class="row px-5">
                    <div class="col-6 p-5" data-aos="zoom-in-left" data-aos-duration="1000">
                        <div class="right w-100 h-100 shadow-lg" style="border: solid 1px #000;">
                            <img
                                src="https://github.com/Manjares360/villareyesimage/blob/main/amacan/photo_2024-10-29_15-36-45.jpg?raw=true"
                                width="100%" height="450" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-6 text-dark" data-aos="fade-left" data-aos-duration="1000">
                        <p class="mt-5 pt-5 px-5 fw-semibold" style="font-size: 15px; line-height: 1.7; letter-spacing: 1px">Our Vision</p>
                        <p class="mt-2 px-5 fw-light" style="font-size: 12px; line-height: 1.7; letter-spacing: 1px">Our vision is to offer a relaxing getaway...</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mission px-5" style="background-color : #011F37ff;" data-aos="fade-up" data-aos-duration="800">
            <div class="container">
                <div class="row px-5">
                    <div class="col-6 text-light" data-aos="fade-right" data-aos-duration="1000">
                        <p class="mt-5 pt-5 px-5 fw-semibold" style="font-size: 15px; line-height: 1.7; letter-spacing: 1px">Our Mission</p>
                        <p class="mt-2 px-5 fw-light" style="font-size: 12px; line-height: 1.7; letter-spacing: 1px">We strive to be the leading resort...</p>
                    </div>
                    <div class="col-6 p-5" data-aos="zoom-in-right" data-aos-duration="1200">
                        <div class="right w-100 h-100 shadow-lg" style="border: solid 1px #ffffff86;">
                            <img
                                src="https://github.com/Manjares360/villareyesimage/blob/main/vr/photo_2024-10-29_15-40-34.jpg?raw=true"
                                width="100%" height="450" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
        ...
        <div class="map my-5 px-2 w-100" data-aos="fade-up" data-aos-duration="1000">
            <iframe width="100%" class="px-5" height="700" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
